...
Jumper.Play.prototype = {
  ...
  create: function() {
    ...
    // create star 
    this.star = this.game.add.image( 10, 10, 'star' );
    this.star.fixedToCamera = true;

    // create counter
    textcounter = this.add.text( 50, 10, counter.toString(), { font: '26px Segoe UI', fill: '#aa3377' });
    textcounter.fixedToCamera = true;

    // cursor controls
    this.cursor = this.input.keyboard.createCursorKeys();
  },

  // Comunicación AJAX para guardar en la base de datos
  savedatabase: function() {
    ...
    var urlllamada = 'https://phpdatabase.gmartiifp.repl.co/index.php';
  ...
  nuevousuario: function() {
    var user = 'usuario';
    var pass = 'password';
    var urlllamada = 'https://phpdatabase.gmartiifp.repl.co/newuser.php';
